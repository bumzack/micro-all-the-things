...
class DefaultApi extends runtime.BaseAPI {
    /**
     */
    async customerPricesRaw(requestParameters, initOverrides) {
        console.log("XXX   " + JSON.stringify(requestParameters));
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(models_1.CustomerPriceEntryFromJSON));
    }
    /**
     */
    async customerPrices(requestParameters, initOverrides) {
