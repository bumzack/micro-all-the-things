...
import static at.bumzack.constt.UrlConsts.PimCategoriessUrl;
...
public class PimCategoryDbReaderController {
    ...
    // curl http://localhost:8080/pim/categories/0/5
    ...
    private Mono<String> sendToSolrWriter(final Category data) {
...
//        LOG.info("URL of Solr Writer {}", solrWriter.getRequestUrl());
    ...
    @RouterOperations({
            @RouterOperation(path = "/pim/categories",
                    method = GET,
