...
curl localhost:3030/api/backend/openapiclient/webflux_search_search_index | jq >webflux_search_search_index.json
...
OUTPUT_PATH=${REPO_PATH}/../generated-clients
...
java -jar $OPENAPI_CLI generate \
  ...
  --library webclient \
  -o $OUTPUT_PATH \
  --additional-properties=invokerPackage=at.bumzack.clients.solr.searchindexdoc,apiPackage=at.bumzack.clients.solr.searchindexdoc.api,modelPackage=at.bumzack.clients.solr.searchindexdoc.model,useSpringBoot3=true,dateLibrary=java8,artifactId=webflux_search_search_index_client,artifactVersion=0.0.1-SNAPSHOT,groupId=foryouandyourfakewebshop
