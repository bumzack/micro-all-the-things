...
java -jar $OPENAPI_CLI generate \
  ...
  --library webclient \
  -o $OUTPUT_PATH \
  --additional-properties=invokerPackage=at.bumzack.customerservice,apiPackage=at.bumzack.customerservice.api,modelPackage=at.bumzack.customerservice.model,useSpringBoot3=true,dateLibrary=java8,artifactId=webflux_customer_service,artifactVersion=0.0.1-SNAPSHOT,groupId=foryouandyourfakewebshop
