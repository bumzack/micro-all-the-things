...
OUTPUT_PATH=${REPO_PATH}/../generated-clients/customerservice
...
java -jar $OPENAPI_CLI generate \
  ...
  --library webclient \
  -o $OUTPUT_PATH \
  --additional-properties=invokerPackage=at.bumzack.customerservice,apiPackage=at.bumzack.customerservice.api,modelPackage=at.bumzack.customerservice.model,useSpringBoot3=true,dateLibrary=java8-localdatetime,artifactId=webflux_customer_service_client,artifactVersion=0.0.1-SNAPSHOT,groupId=foryouandyourfakewebshop


rm -rf  ../src/main/java/at/bumzack/customerservice

mv ../generated-clients/customerservice/src/main/java/at/bumzack/customerservice ../src/main/java/at/bumzack
