...
public class SolrMovieAkasWriterApplication {

    private final RegisterMicroService registerMicroService;

    public SolrMovieAkasWriterApplication(final RegisterMicroService registerMicroService) {
        this.registerMicroService = registerMicroService;
    }

    public static void main(String[] args) {
        try {
            SpringApplication.run(SolrMovieAkasWriterApplication.class, args);
