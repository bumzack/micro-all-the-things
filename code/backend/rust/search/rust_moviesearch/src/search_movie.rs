pub mod filters_search_movie {
    ...
    use common::meili_search::handlers_search_entity::{meili_search_movie, meili_search_movie_paginated};
    ...
    pub fn search_movie_route() -> impl Filter<Extract=(impl Reply, ), Error=warp::Rejection> + Clone
    {
        ...
        let search = server
            ...
            .and_then(|name: String| {
                println!("GET /api/movie/:name  matched");
        ...
        let search_name = server1
            ...
            .and_then(|req: SearchPaginatedRequest| {
                //  println!("POST /api/movie/  matched");
