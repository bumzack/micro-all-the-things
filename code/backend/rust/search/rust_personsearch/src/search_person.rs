    ...
    pub fn filter_person_route(
        ...
        let search_nconsts_meili = server3
            ...
            .and_then(|req: SearchPersonList| {
                ...
                filter_person("nconst".to_string(), req.nconsts, Engine::Meili, &CLIENT)
            });
        ...
        let search_nconsts_solr = server3
            ...
            .and_then(|req: SearchPersonList| {
                ...
                filter_person("nconst".to_string(), req.nconsts, Engine::Solr, &CLIENT)
            });
        ...
        let search_name_meili = server
            ...
            .and_then(|req: SearchPaginatedRequest| {
                ...
                read_person_documents(req.offset, req.limit, Engine::Meili, &CLIENT)
            });
        ...
        let search_name_solr = server
            ...
            .and_then(|req: SearchPaginatedRequest| {
                ...
                read_person_documents(req.offset, req.limit, Engine::Solr, &CLIENT)
            });
