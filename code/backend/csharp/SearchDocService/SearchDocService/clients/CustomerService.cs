...
namespace CustomerService
{
    ...
    {
        private string _baseUrl = "http://localhost:8980";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public CustomerService(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual System.Threading.Tasks.Task<Customer> AddCustomerAsync(AddCustomerRequest body)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Customer> AddCustomerAsync(AddCustomerRequest body, System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<Customer> GetCustomerAsync(string email)
        {
            return GetCustomerAsync(email, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<Customer> GetCustomerAsync(string email, System.Threading.CancellationToken cancellationToken)
        {
            if (email == null)
                throw new System.ArgumentNullException("email");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v1/customer/{email}");
