...
public class SolrService {
    ...
    public SolrResponse<SearchDoc> searchByText(final String searchText, final int limit, final int offset, final ParameterizedTypeReference<SolrResponse<SearchDoc>> typeRef) {
        ...
        return executeSolrGet(typeRef, url).block();
    }
}
