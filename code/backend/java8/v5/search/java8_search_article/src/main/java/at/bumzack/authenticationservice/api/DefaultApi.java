...
import at.bumzack.authenticationservice.Pair;
    ...
    try {
      ...
      try {
        ...
        return new ApiResponse<AuthenticationEntry>(
          ...
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<AuthenticationEntry>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
