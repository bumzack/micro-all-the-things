...
java -jar $OPENAPI_CLI generate \
  ...
  --library native \
  -o $OUTPUT_PATH \
  --additional-properties=invokerPackage=at.bumzack.priceservice,apiPackage=at.bumzack.priceservice.api,modelPackage=at.bumzack.priceservice.model,useSpringBoot3=true,dateLibrary=java8-localdatetime,artifactId=java8_price_service_client,artifactVersion=0.0.1-SNAPSHOT,groupId=foryouandyourfakewebshop
