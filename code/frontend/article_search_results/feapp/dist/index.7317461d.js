 ...
 */
t = "undefined" != typeof window ? window : r, n = function (e, t) {
 ...
 */
        function (e) {
            var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, y, m, x, b = "sizzle" + 1 * new Date, w = e.document,
                T = 0, C = 0, E = ue(), S = ue(), k = ue(), A = ue(), N = function (e, t) {
                    return e === t && (f = !0), 0
                ...
                $ = "\\[" + M + "*(" + I + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + I + "))|)" + M + "*\\]",
                F = ":(" + I + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + $ + ")*)|.*)\\)|)",
                W = new RegExp(M + "+", "g"), B = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$", "g"),
                _ = new RegExp("^" + M + "*," + M + "*"), z = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"),
                U = new RegExp(M + "|>"), X = new RegExp(F), V = new RegExp("^" + I + "$"), J = {
                    ID: new RegExp("^#(" + I + ")"),
                    CLASS: new RegExp("^\\.(" + I + ")"),
                    TAG: new RegExp("^(" + I + "|[*])"),
                    ATTR: new RegExp("^" + $),
                ...
                }, Y = /HTML$/i, G = /^(?:input|select|textarea|button)$/i, Q = /^h\d$/i, K = /^[^{]+\{\s*\[native \w/,
                Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/,
            ...
            for (t in n = se.support = {}, o = se.isXML = function (e) {
                ...
                })), n.cssHas || v.push(":has"), v = v.length && new RegExp(v.join("|")), y = y.length && new RegExp(y.join("|")), t = K.test(h.compareDocumentPosition), x = t || K.test(h.contains) ? function (e, t) {
            ...
            return me.prototype = r.filters = r.pseudos, r.setFilters = new me, a = se.tokenize = function (e, t) {
                ...
                if (n = n || [], 1 === d.length) {
                    ...
                    for (o = J.needsContext.test(e) ? 0 : u.length; o-- && (l = u[o], !r.relative[c = l.type]);) if ((f = r.find[c]) && (i = f(l.matches[0].replace(te, ne), ee.test(u[0].type) && ye(t.parentNode) || t))) {
    ...
    }), w.ready.then = F.then, "complete" === v.readyState || "loading" !== v.readyState && !v.documentElement.doScroll ? e.setTimeout(w.ready) : (v.addEventListener("DOMContentLoaded", W), e.addEventListener("load", W));
    ...
    var Y = new J, G = new J, Q = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, K = /[A-Z]/g;
    ...
    function be(e, t, n, r, i) {
        for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === x(o)) w.merge(p, o.nodeType ? [o] : o); else if (xe.test(o)) {
    ...
    var Ae = /<script|<style|<link/i, Ne = /checked\s*(?:[^=]|=\s*.checked.)/i, je = /^\s*<!\[CDATA\[|\]\]>\s*$/g;
    ...
    function Pe(e, t, n, r) {
        ...
        if (y || p > 1 && "string" == typeof v && !d.checkClone && Ne.test(v)) return e.each((function (i) {
            var o = e.eq(i);
            y && (t[0] = v.call(this, i, o.html())), Pe(o, t, n, r)
        }));
        if (p && (a = (i = be(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
            for (u = (s = w.map(ye(i, "script"), qe)).length; f < p; f++) l = i, f !== g && (l = w.clone(l, !0, !0), u && w.merge(s, ye(l, "script"))), n.call(e[f], l, f);
            if (u) for (c = s[s.length - 1].ownerDocument, w.map(s, Le), f = 0; f < u; f++) l = s[f], ge.test(l.type || "") && !Y.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {nonce: l.nonce || l.getAttribute("nonce")}, c) : m(l.textContent.replace(je, ""), l, c))
        }
        return e
    }
    ...
    w.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(d.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || w.isXMLDoc(e))) for (a = ye(s), r = 0, i = (o = ye(e)).length; r < i; r++) Oe(o[r], a[r]);
            if (t) if (n) for (o = o || ye(e), a = a || ye(s), r = 0, i = o.length; r < i; r++) He(o[r], a[r]); else He(e, s);
    ...
    var Me = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Ie = /^--/, $e = function (t) {
            ...
            return r
        }, We = new RegExp(ne.join("|"), "i"), Be = "[\\x20\\t\\r\\n\\f]",
        _e = new RegExp("^" + Be + "+|((?:^|[^\\\\])(?:\\\\.)*)" + Be + "+$", "g");

    function ze(e, t, n) {
        var r, i, o, a, s = Ie.test(t), u = e.style;
        return (n = n || $e(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(_e, "$1") || void 0), "" !== a || ie(e) || (a = w.style(e, t)), !d.pixelBoxStyles() && Me.test(a) && We.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a
    }
    ...
    var Xe = ["Webkit", "Moz", "ms"], Ve = v.createElement("div").style, Je = {};

    function Ye(e) {
        var t = w.cssProps[e] || Je[e];
        return t || (e in Ve ? e : Je[e] = function (e) {
    ...
    function tt(e, t, n) {
        var r = $e(e), i = (!d.boxSizingReliable() || n) && "border-box" === w.css(e, "boxSizing", !1, r), o = i,
    ...
    w.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, a, s = X(t), u = Ie.test(t), l = e.style;
        ...
        css: function (e, t, n, r) {
            var i, o, a, s = X(t);
            return Ie.test(t) || (t = Ye(s)), (a = w.cssHooks[t] || w.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = ze(e, t, r)), "normal" === i && t in Ke && (i = Ke[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), w.each(["height", "width"], (function (e, t) {
        w.cssHooks[t] = {
            get: function (e, n, r) {
                if (n) return !Ge.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, r) : Fe(e, Qe, (function () {
                    return tt(e, t, r)
                }))
            }, set: function (e, n, r) {
                var i, o = $e(e), a = !d.scrollboxSize() && "absolute" === o.position,
                    s = (a || r) && "border-box" === w.css(e, "boxSizing", !1, o), u = r ? et(e, t, r, s, o) : 0;
    ...
    w.fn.extend({
        ...
        addClass: function (e) {
            ...
            return h(e) ? this.each((function (t) {
                ...
                if (r = yt(this), n = 1 === this.nodeType && " " + vt(r) + " ") {
            ...
            })) : "boolean" == typeof t && s ? t ? this.addClass(e) : this.removeClass(e) : (n = mt(e), this.each((function () {
                if (s) for (o = w(this), i = 0; i < n.length; i++) r = n[i], o.hasClass(r) ? o.removeClass(r) : o.addClass(r); else void 0 !== e && "boolean" !== a || ((r = yt(this)) && Y.set(this, "__className__", r), this.setAttribute && this.setAttribute("class", r || !1 === e ? "" : Y.get(this, "__className__") || ""))
            })))
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    w.extend(w.event, {
        trigger: function (t, n, r, i) {
            ...
            if (a = d = s = r = r || v, 3 !== r.nodeType && 8 !== r.nodeType && !bt.test(m + w.event.triggered) && (m.indexOf(".") > -1 && (x = m.split("."), m = x.shift(), x.sort()), l = m.indexOf(":") < 0 && "on" + m, (t = t[w.expando] ? t : new w.Event(m, "object" == typeof t && t)).isTrigger = i ? 2 : 3, t.namespace = x.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + x.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = r), n = null == n ? [t] : w.makeArray(n, [t]), p = w.event.special[m] || {}, i || !p.trigger || !1 !== p.trigger.apply(r, n))) {
                if (!i && !p.noBubble && !g(r)) {
                ...
                for (o = 0; (a = y[o++]) && !t.isPropagationStopped();) d = a, t.type = o > 1 ? u : p.bindType || m, (f = (Y.get(a, "events") || Object.create(null))[t.type] && Y.get(a, "handle")) && f.apply(a, n), (f = l && a[l]) && f.apply && V(a) && (t.result = f.apply(a, n), !1 === t.result && t.preventDefault());
    ...
    var Dt = /%20/g, qt = /#.*$/, Lt = /([?&])_=[^&]*/, Ht = /^(.*?):[ \t]*([^\r\n]*)$/gm, Ot = /^(?:GET|HEAD)$/,
        Pt = /^\/\//, Rt = {}, Mt = {}, It = "*/".concat("*"), $t = v.createElement("a");
    ...
    $t.href = Tt.href, w.extend({
        ...
        ajax: function (t, n) {
            ...
            if (d.data && d.processData && "string" != typeof d.data && (d.data = w.param(d.data, d.traditional)), Wt(Rt, d, n, E), l) return E;
            for (f in (c = w.event && d.global) && 0 == w.active++ && w.event.trigger("ajaxStart"), d.type = d.type.toUpperCase(), d.hasContent = !Ot.test(d.type), i = d.url.replace(qt, ""), d.hasContent ? d.data && d.processData && 0 === (d.contentType || "").indexOf("application/x-www-form-urlencoded") && (d.data = d.data.replace(Dt, "+")) : (p = d.url.slice(i.length), d.data && (d.processData || "string" == typeof d.data) && (i += (Et.test(i) ? "&" : "?") + d.data, delete d.data), !1 === d.cache && (i = i.replace(Lt, "$1"), p = (Et.test(i) ? "&" : "?") + "_=" + Ct.guid++ + p), d.url = i + p), d.ifModified && (w.lastModified[i] && E.setRequestHeader("If-Modified-Since", w.lastModified[i]), w.etag[i] && E.setRequestHeader("If-None-Match", w.etag[i])), (d.data && d.hasContent && !1 !== d.contentType || n.contentType) && E.setRequestHeader("Content-Type", d.contentType), E.setRequestHeader("Accept", d.dataTypes[0] && d.accepts[d.dataTypes[0]] ? d.accepts[d.dataTypes[0]] + ("*" !== d.dataTypes[0] ? ", " + It + "; q=0.01" : "") : d.accepts["*"]), d.headers) E.setRequestHeader(f, d.headers[f]);
            if (d.beforeSend && (!1 === d.beforeSend.call(h, E, d) || l)) return E.abort();
            if (C = "abort", m.add(d.complete), E.done(d.success), E.fail(d.error), r = Wt(Mt, d, n, E)) {
    ...
    w.ajaxSetup({
        ...
        return s > -1 && (r = vt(e.slice(s)), e = e.slice(0, s)), h(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && w.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        w.cssHooks[t] = Ue(d.pixelPosition, (function (e, n) {
            if (n) return n = ze(e, t), Me.test(n) ? w(e).position()[t] + "px" : n
        }))
...
}, "object" == typeof r ? r = t.document ? n(t, !0) : function (e) {
...
window.$ = window.jQuery = e(r), e(r)(document).ready((() => {
    console.log("yo"), e(r)("#searchMovie").keydown((t => {
        if (13 == t.which) {
            t.preventDefault();
            const n = e(r)("#searchMovie").val();
            console.log(`return pressed     ${n}  `);
            const a = "http://proxy.proxythingi.at/rust/meili/search", s = {
                q: n,
                offset: 0,
                limit: 5,
                customer: {
            ...
            console.log(`sending request  to url ${a}. req  ${JSON.stringify(s, null, 4)} `), function (e = "", t = {}) {
                return i(this, void 0, void 0, (function* () {
                    ...
                    return [yield n.json(), n.headers]
                }))
            }(a, s).then((([t, n]) => {
                for (var i of (console.log(t), console.log(n), n.entries())) console.log(i[0] + ": " + i[1]);
                const a = n.get("x-duration"), s = n.get("x-provided-by");
                console.log(`proxythingi backend  ${s},  duration  ${a} `);
                const u = t;
                console.log(`movies.len ${u.articles.length} `), e(r)("#search_results").empty(), u.articles.forEach((t => {
                    const n = o(t);
                    e(r)("#search_results").append(n)
                }))
            }))
        }
    }))
...
const o = e => {
    const t = e.article.titles.join(" / "), n = "Characters: " + e.article.characters.join(" / "),
        r = "Actresses / Actors : " + e.article.actors.join(" / ");
    let i;
    return i = void 0 !== e.customer_price ? `SRP € <sr>${e.price.toFixed(2)}</sr>, your price: € ${e.customer_price.toFixed(2)}` : `SRP € ${e.price} `, `   \n        <div class="col">\n            <div class="card h-100">\n                 <div class="card-body">\n                    <h5 class="card-title">${t}</h5>\n                    <p class="card-text">${r}</p>\n                    <p class="card-text">${n}</p>\n                </div>\n                <div class="card-footer">\n                    <div class="row row-cols-2 row-cols-md-2 g-6">\n                        <div class="col">\n                            ${i}\n                        </div>\n                        <div class="col">\n                            <a href="#" class="btn btn-primary">Add to Cart</a>\n                        </div>\n                    </div>\n                </div>\n            </div>\n        </div>\n    `
};
//# sourceMappingURL=index.7317461d.js.map
