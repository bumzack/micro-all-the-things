 ...
 */
    !function (e, n) {
        "use strict";
        "object" == typeof t ? t = e.document ? n(e, !0) : function (e) {
 ...
 */
        ...
        var ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
            ...
            re = v.documentElement, ie = function (e) {
    ...
    window.$ = window.jQuery = e(t), e(t)(document).ready((() => {
        console.log("yo"), e(t)("#searchMovie").keydown((i => {
            if (13 == i.which) {
                i.preventDefault();
                const o = e(t)("#searchMovie").val();
                console.log(`return pressed     ${o}  `);
                ...
                console.log(`sending request  to url ${a}. req  ${JSON.stringify(s, null, 4)} `), function (e = "", t = {}) {
                    ...
                    for (var o of (console.log(n), console.log(i), i.entries())) console.log(o[0] + ": " + o[1]);
                    const a = i.get("x-duration"), s = i.get("x-provided-by");
                    console.log(`proxythingi backend  ${s},  duration  ${a} `);
                    const u = n;
                    console.log(`movies.len ${u.articles.length} `), e(t)("#search_results").empty(), u.articles.forEach((n => {
                        const i = r(n);
                        e(t)("#search_results").append(i)
                    }))
                }))
            }
        }))
...
//# sourceMappingURL=index.d1732cfe.js.map
