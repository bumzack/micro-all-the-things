...
curl -X POST -H 'Content-type:application/json' --data-binary '{
  "add-field":{       "name":"tconst",       "type":"string",  "stored":true, indexed:"true" },
  "add-field":{       "name":"directors",    "type":"string",  "stored":true, "multiValued":true, indexed:"true" },
  "add-field":{       "name":"writers",      "type":"string",  "stored":true, "multiValued":true, indexed:"true" }
